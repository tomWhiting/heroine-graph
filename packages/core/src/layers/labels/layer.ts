...
import { LabelManager, type LabelData } from "./manager.ts";
...
export class LabelsLayer implements Layer {
  ...
  render(
    ...
    const { device } = this.context;
    const { viewportX, viewportY, scale, canvasWidth, canvasHeight, positionProvider } = this.renderContext;
    ...
    const viewportData = new Float32Array([
      ...
      0, 0, 0,         // padding to align vec3 at byte 20-31
      0, 0, 0,         // _padding vec3 at byte 32-43
